...
const TermsPage = () => {
  return (
    <div className={style.TermsPage}>
      ...
      <Typography variant="paragraph" hasMargin>
        PullQuest.net is&nbsp;a&nbsp;E-commerce Site Providing Website Engagement Software for Businesses
        as&nbsp;a&nbsp;service.
      </Typography>
      <Typography variant="paragraph" hasMargin>
      ...
      <Typography variant="paragraph" hasMargin>
        ...
        or&nbsp;misappropriation of&nbsp;your account. PullQuest and its associates reserve the right to&nbsp;refuse
        or&nbsp;cancel service, terminate accounts, or&nbsp;remove or&nbsp;edit content in&nbsp;our sole discretion.
      </Typography>
      <Typography variant="paragraph" hasMargin>
        PullQuest does not knowingly collect, either online or&nbsp;offline, personal information from persons under the
        age of&nbsp;thirteen. If&nbsp;you are under&nbsp;18, you may use PullQuest.net only with permission
      ...
      <Typography variant="paragraph" hasMargin>
        ...
        By&nbsp;using any product, service or&nbsp;functionality originating from the PullQuest.net domain, you hereby
        acknowledge and consent that PullQuest may share such information and data with any third party with whom
        PullQuest has a&nbsp;contractual relationship to&nbsp;provide the requested product, service
      ...
      <Typography variant="paragraph" hasMargin uppercase>
        ...
        GRAPHICS CONTAINED ON&nbsp;THE SITE FOR ANY PURPOSE. TO&nbsp;THE MAXIMUM EXTENT PERMITTED BY&nbsp;APPLICABLE
        LAW, ALL&nbsp;SUCH INFORMATION, SOFTWARE, PRODUCTS, SERVICES AND RELATED GRAPHICS ARE PROVIDED
        &laquo;AS&nbsp;IS&raquo; WITHOUT WARRANTY OR&nbsp;CONDITION OF&nbsp;ANY KIND. PullQuest LLC&nbsp;AND/OR ITS
        SUPPLIERS HEREBY DISCLAIM&nbsp;ALL&nbsp;WARRANTIES AND CONDITIONS WITH REGARD TO&nbsp;THIS INFORMATION,
        SOFTWARE, PRODUCTS, SERVICES AND RELATED GRAPHICS, INCLUDING ALL&nbsp;IMPLIED WARRANTIES OR&nbsp;CONDITIONS
        OF&nbsp;MERCHANTABILITY, FITNESS FOR A&nbsp;PARTICULAR PURPOSE, TITLE AND NON-INFRINGEMENT.
      </Typography>
      <Typography variant="paragraph" hasMargin uppercase>
        TO&nbsp;THE MAXIMUM EXTENT PERMITTED BY&nbsp;APPLICABLE LAW, IN&nbsp;NO&nbsp;EVENT SHALL PullQuest
        LLC&nbsp;AND/OR ITS SUPPLIERS BE&nbsp;LIABLE FOR ANY DIRECT, INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL,
        CONSEQUENTIAL DAMAGES OR&nbsp;ANY DAMAGES WHATSOEVER INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS
        OF&nbsp;USE, DATA OR&nbsp;PROFITS, ARISING OUT OF&nbsp;OR&nbsp;IN&nbsp;ANY WAY CONNECTED WITH THE USE
        OR&nbsp;PERFORMANCE OF&nbsp;THE SITE, WITH THE DELAY OR&nbsp;INABILITY TO&nbsp;USE THE SITE OR&nbsp;RELATED
        ...
        IF&nbsp;PullQuest LLC&nbsp;OR ANY OF&nbsp;ITS SUPPLIERS HAS BEEN ADVISED OF&nbsp;THE POSSIBILITY
        OF&nbsp;DAMAGES. BECAUSE SOME STATES/JURISDICTIONS DO&nbsp;NOT ALLOW THE EXCLUSION OR&nbsp;LIMITATION
      ...
      <Typography variant="paragraph" hasMargin>
        ...
        and PullQuest as&nbsp;a&nbsp;result of&nbsp;this agreement or&nbsp;use of&nbsp;the Site. PullQuest&rsquo;s
        performance of&nbsp;this agreement is&nbsp;subject to&nbsp;existing laws and legal process, and nothing
        contained in&nbsp;this agreement is&nbsp;in&nbsp;derogation of&nbsp;PullQuest&rsquo;s right to&nbsp;comply with
        governmental, court and law enforcement requests or&nbsp;requirements relating to&nbsp;your use of&nbsp;the Site
        or&nbsp;information provided to&nbsp;or&nbsp;gathered by&nbsp;PullQuest with respect to&nbsp;such use.
      ...
      <Typography variant="paragraph" hasMargin>
        ...
        PullQuest with respect to&nbsp;the Site and it&nbsp;supersedes all prior or&nbsp;contemporaneous communications
        and proposals, whether electronic, oral or&nbsp;written, between the user and PullQuest with respect to&nbsp;the
        Site. A&nbsp;printed version of&nbsp;this agreement and of&nbsp;any notice given in&nbsp;electronic form shall
        be&nbsp;admissible in&nbsp;judicial or&nbsp;administrative proceedings based upon or&nbsp;relating to&nbsp;this
        agreement to&nbsp;the same extent an&nbsp;d&nbsp;subject to&nbsp;the same conditions as&nbsp;other business
      ...
      <Typography className={style.text} variant="paragraph" hasMargin>
