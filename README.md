...
### /store/
В этом святом месте хранится все что касается Redux в приложении.
Мы используем паттерн "уточек" [Redux Ducks](https://github.com/erikras/ducks-modular-redux), в котором структура состояния 
